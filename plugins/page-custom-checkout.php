...
<main id="primary" class="site-main custom-checkout-page">
    <section class="pscoHero">
    <div class="container">
        <div class="pscoHero__wrap">
            <div class="pscoHero__content">
                ...
                <div class="pscoHero__actions">
                    <a href="/contact" class="pscoBtn pscoBtn--primary">Обсудить checkout</a>
    ...
    <div class="container">
        <div class="pscoCta__box">
            ...
            <div class="pscoCta__actions">
                <a href="/contact" class="pscoBtn pscoBtn--primary">Обсудить задачу</a>
