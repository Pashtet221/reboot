<?php
/*
Template Name: DaData WooCommerce
Template Post Type: plugin
*/
get_header();
?>

<main id="primary" class="site-main dadata-page">
   <section class="psddHero">
    <div class="container">
        <div class="psddHero__wrap">
            <div class="psddHero__content">
