<?php
/*
Template Name: CDEK Delivery
Template Post Type: plugin
*/
get_header();
?>

<main id="primary" class="site-main cdek-delivery-page">
        ...
        <div class="pscdHero__wrap">
            <div class="pscdHero__content">
                ...
                <div class="pscdHero__actions">
                    <a href="/contact" class="pscdBtn pscdBtn--primary">Подключить CDEK</a>
    ...
    <div class="container">
        <div class="pscdCta__box">
            ...
            <div class="pscdCta__actions">
                <a href="/contact" class="pscdBtn pscdBtn--primary">Обсудить интеграцию</a>
